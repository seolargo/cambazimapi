...
exports.create = (req, res) => {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        blog.createdAt = req.user.createdAt;
        //blog.photo.data = 
        // categories and tags
        ...
        if (files.photo) {
            if (files.photo.size > 10000000) {
                return res.status(400).json({
                    error: 'Resmin boyutu 1MBden daha az olmalı'
                });
            }
        ...
        if (files.photos && files.photos.length > 0) {
            post.photos=[];
            for (let photo in files.photos){
              data = fs.readFileSync(files.photo.path);
              contentType = files.photo.type;
              post.photos.send(data, contentType);
            }
          }*/
...
exports.list = (req, res) => {
    //Blog.find() --> This will give us the all blogs.
    Blog.find({})
...
exports.listAllBlogsCategoriesTags = (req, res) => {
    ...
    Blog.find({})
        ...
        .exec((err, data) => {
            ...
            blogs = data; // blogs
            // Get all categories.
            // It will get us categories or error.
            Category.find({}).exec((err, c) => {
                ...
                Tag.find({}).exec((err, t) => {
                    ...
                    tags = t;
                    // Return all blogs categories tags and size.
